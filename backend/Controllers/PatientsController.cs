...
public class PatientsController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<PatientResponseDto>>> GetPatients()
    {
        ...
        return Ok(patients.Select(ToResponseDto));
    }
    ...
    public async Task<ActionResult<PatientResponseDto>> GetPatient(int id)
    {
        ...
        return Ok(ToResponseDto(patient));
    }
    ...
    )
    {
        ...
        var patient = new Patient
        {
            ...
            AlternateMobile = Clean(dto.AlternateMobile),
            ...
            ReferredBy = Clean(dto.ReferredBy),
        ...
        var response = ToResponseDto(patient);
    ...
    )
    {
        ...
        patient.Mobile = dto.Mobile.Trim();
        patient.AlternateMobile = Clean(dto.AlternateMobile);
        patient.Email = Clean(dto.Email);
        patient.Address = Clean(dto.Address);
        patient.City = Clean(dto.City);
        patient.State = Clean(dto.State);
        patient.PinCode = Clean(dto.PinCode);
        patient.BloodGroup = Clean(dto.BloodGroup);
        patient.ReferredBy = Clean(dto.ReferredBy);
        patient.Notes = Clean(dto.Notes);
        patient.Status = dto.Status.Trim();
    ...
    private async Task<string> GenerateNextUhid()
    {
        ...
        var nextNumber = (lastPatient?.Id ?? 0) + 1;

        return $"SMHC-{nextNumber:D4}";
    }
    ...
    private static PatientResponseDto ToResponseDto(Patient patient)
    {
