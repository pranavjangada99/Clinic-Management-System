    ...
    <aside className="fixed left-0 top-0 flex h-screen w-72 flex-col border-r border-slate-200 bg-white">
      ...
      <div className="border-t border-slate-200 p-5">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-3 transition-all duration-200 hover:border-slate-300 hover:bg-white"
        >
